...
wait2 = 0
resetmove2 = 0
function zbigniewonStart( agent, actorKnowledge, time)
        agent:selectWeapon(Enumerations.Chaingun);
end

function zbigniewwhatTo( agent, actorKnowledge, time)
        mindist = 9999
		mindisttrig = -1
        ...
        if ( actorKnowledge:isMoving()==false or resetmove2 == 1) then
				resetmove2 = 0
